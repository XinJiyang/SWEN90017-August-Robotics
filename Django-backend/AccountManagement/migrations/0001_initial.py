    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('privilege', models.CharField(choices=[('admin', 'admin'), ('manager', 'manager'), ('viewer', 'viewer')], default='viewer')),
                ('email', models.EmailField(max_length=32, verbose_name='user_email')),
